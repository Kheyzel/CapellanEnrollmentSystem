...
<body>
  <div class="container" id="container">
    ...
    <div class="content">
      <div class="content-wrapper">
        ...
        <div class="student-grade">
          <p><strong>Grade Level / Strand: </strong>12 - {{ $student->course->course }}</p>
        </div>
          ...
          <table class="content-table" style="width: 90%">
              ...
              <tbody>
                @foreach ($std_payment_g12 as $payment)
                                ...
                                @endforeach
                <tr>
                  <td colspan="3" style="text-align: end; font-weight: bold;">Paid in Total: Php {{ $std_total_paid_g12 }}.00</td>
                </tr>
              </tbody>
            </table>
          ...
          <p>
            ...
            Php {{ $total_miscellaneous_fee_g12 }}.00
          </p>
    ...
    <div class="reg-note">
      <p><strong>STUDENT'S TRANSACTIONS COPY: </strong> This is to certify that the information stated above was all valid and has been acknowledged by the Office of Capellan Institute of Technology San Pablo.</p>
  </div>
    </div>
  </div>
