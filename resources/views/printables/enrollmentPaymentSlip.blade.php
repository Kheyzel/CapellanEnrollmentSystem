...
<style>
    ...
    * {
    ...
    .content-student-copy .content-wrapper h5 {
        text-align: center;
        padding-top: 10px;
        margin-bottom: 10px;
        color: #061783;
...
@section('content')
    ...
    <body>
        <div id="container" class="container">
            <div class="header">
                <div class="header-wrapper">
                    ...
                    <div class="reg-copy" style="padding-top: 15px">
                    ...
                    <div class="academic-year">
                        ...
                        {{-- <p><strong>Reciept Number {{ $year }}{{ $school_id }}{{ $ActivityLogs->id }}</strong> </p> --}}
                    </div>
                </div>
            </div>
            <div class="content">
                <div class="content-wrapper">
                    ...
                    <div class="head" style="margin-top: -20px">
                        <h5>ENROLLMENT PAYMENT INFORMATION SLIP
                        </h5>
                    </div>
                    ...
                    <div class="student-info-left">
                        ...
                        <p><strong>Grade Level / Track: </strong>{{ $student->yearlevel->yearlevel }} /
                            {{ $student->course->course }}</p>
                        <p><strong>Mode of Payment: </strong>
                            @foreach ($student->TuitionPayment as $item)
                        ...
                        <p><strong>Miscellaneous Fee: </strong>
                    ...
                    <div class="student-info-right">
                        ...
                        <!-- <p><strong>Remaining Balance: </strong>1900</p> -->
                    </div>
                    <div class="payment-summary-reg">
                        <h5>Payment Summary</h5>
                    </div>
                    <div class="payment-summary-reg-content">
                        <p><strong>Total of Miscellaneous/Tuition Fee: </strong>
                    ...
                    <div class="reg-note">
                        <p><strong>REGISTRAR COPY: </strong> This is to certify that the student stated above was officially
                            enrolled and have been acknowledged by the Office of the Registrar.</p>
                    </div>
                </div>
            </div>
            <hr class="dashed-hr">

            <div class="header-student-copy">
                <div class="header-wrapper">
                    <div class="logo">
                        <img src="{{asset('../img/capellan-logo.png')}}" alt="Logo">
                    </div>
                    ...
                    <div class="reg-copy" style="padding-bottom:15px">
            ...
            <div class="content-student-copy">
                <div class="content-wrapper">
                    <hr>
                    <div class="head">
                        <h5 style="margin-top: -20px">ENROLLMENT PAYMENT INFORMATION SLIP</h5>
                    </div>
                    <div class="student-name">
                        <p><strong>Name of Student: </strong> {{ $student->last_name }}, {{ $student->first_name }}
                            {{ $student->middle_name }} {{ $student->suffix }}</p>
                    ...
                    <div class="student-info-left">
                        ...
                        <p><strong>Mode of Payment: </strong>
                            @foreach ($student->TuitionPayment as $item)
                               Php {{ $item->mode_of_payment }}.00
                            @endforeach
                        </p>
                        <p><strong>Discount Type: </strong>
                            @foreach ($student->TuitionPayment as $item)
                               Php {{ $item->discount_type }}.00
                            @endforeach
                        </p>
                        <p><strong>Miscellaneous Fee: </strong>
                            Php {{$total_miscellaneous_fee}}.00
                    ...
                    <div class="reg-note">
                        <p><strong>STUDENT COPY: </strong> This is to certify that the student stated above was officially
                            enrolled and have been acknowledged by the Office of the Registrar.</p>
                    </div>
                </div>
            </div>
        ...
        <div>
            {{-- <a id = "button"onclick="generatepdf()">Download</a> --}}
            {{-- <a id = "button-back" href="{{route('students_record.show',$student->id) }}">Back</a> --}}
        </div>
        ...
        <script type="text/javascript">
            function generatepdf() {
                ...
                var opt = {
                    margin: 0,
                    filename: '{{ $student->last_name }}-{{ $student->first_name }}-EPaymentSlip',
                    image: {
                        type: 'jpeg',
                        quality: 0.98
                    },
